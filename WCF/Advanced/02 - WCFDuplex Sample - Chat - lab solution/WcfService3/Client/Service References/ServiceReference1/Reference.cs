...
namespace Client.ServiceReference1 {
    ...
    public interface IService1 {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IService1/NormalFunction")]
        System.Threading.Tasks.Task NormalFunctionAsync(string message);
    }
    ...
    public partial class Service1Client : System.ServiceModel.DuplexClientBase<Client.ServiceReference1.IService1>, Client.ServiceReference1.IService1 {
        ...
        public void NormalFunction(string message) {
            base.Channel.NormalFunction(message);
        }
        
        public System.Threading.Tasks.Task NormalFunctionAsync(string message) {
            return base.Channel.NormalFunctionAsync(message);
        }
    }
}
